...
interface IEmissionsControllerTypes {
    ...
    ///      - Burn: Unwraps its EIGEN allotment back into bEIGEN and burns it, permanently removing that
    ///        portion of emissions from circulation. Used to dispose of excess funds.
