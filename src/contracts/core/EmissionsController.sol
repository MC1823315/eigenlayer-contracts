    ...
    EmissionsControllerStorage
{
    ...
    function _processDistribution(
        ...
        if (distribution.distributionType == DistributionType.Burn) {
            // Unwrap the EIGEN allotment back into bEIGEN, then burn it. This permanently
            // removes this portion of emissions from circulation, disposing of excess funds.
    ...
    function _checkDistribution(
        ...
        // Manual and Burn distributions handle emissions differently and don't require submissions.
        require(
